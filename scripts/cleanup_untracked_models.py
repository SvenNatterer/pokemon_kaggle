...
def main():
    ...
    # 2. Clean decks/bot_names.json
    bot_names_path = BASE_DIR / "decks" / "bot_names.json"
    ...
    with open(BASE_DIR / "leaderboard.md", "w") as f:
        f.write(md)
    print("Wrote updated leaderboard.md.")
